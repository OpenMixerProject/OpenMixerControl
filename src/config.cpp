...
namespace OMC
{
    ...
    {
        printf("\n");
        printf("OpenMixerControl OSC-Documentation\n");
        printf("\n");
        printf("\n");
        printf("General format of OSC-Message\n");
        printf("------------------------------\n");
        printf("\n");
        printf("/<action>/<parameter> ,<format> <<values>>\n");
        printf("\n");
        printf("<action> = set, change, toggle, reset\n");
        printf("<parameter> = See table at the end.\n");
        printf("<format> = Depends on the action:\n");
        printf("    set -> \"if\" <index as integer><value as float> \n");
        printf("    set -> \"is\" <index as integer><value as string>\n");
        printf("    change -> \"ii\" <index as integer><amount as integer>\n");
        printf("    toggle -> \"i\" <index as integer>\n");
        printf("    reset -> \"i\" <index as integer>\n");
        printf("\n");
        printf("Examples\n");
        printf("--------\n");
        printf("\n");
        printf("Toggle mute of channel 3: /toggle/ch_mute~,i~~[3]\n");
        printf("\n");
        printf("Set mute of channel 3 On: /set/ch_mute~~~~,if~~[3][1.0]\n");
        printf("Set mute of channel 3 Off: /set/ch_mute~~~~,if~~[3][0.0]\n");
        printf("\n");
        printf("Set volume of channel 10 to 2038: /set/ch_volume~~~~,if~~[10][2038.0]\n");
        printf("\n");
        printf("\n");
