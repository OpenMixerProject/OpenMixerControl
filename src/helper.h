...
class Helper
{
    ...
    public:
        ...
        void SetDebugAll()
        {
            debug_ = 0b11111111111111111111111111111111; // 32 Bit
        }
        ...
        DEBUG_DEF(DEBUG_OSC,      0b00000000000000000000000000000001);
        DEBUG_DEF(DEBUG_SURFACE,  0b00000000000000000000000000000010);
        DEBUG_DEF(DEBUG_DMX,      0b00000000000000000000000000000100);
        DEBUG_DEF(DEBUG_X32CTRL,  0b00000000000000000000000000001000);
        DEBUG_DEF(DEBUG_ADDA,     0b00000000000000000000000000010000);
        DEBUG_DEF(DEBUG_MIXER,    0b00000000000000000000000000100000);
        DEBUG_DEF(DEBUG_GUI,      0b00000000000000000000000001000000);
        DEBUG_DEF(DEBUG_SPI,      0b00000000000000000000000010000000);
        DEBUG_DEF(DEBUG_DSP1,     0b00000000000000000000000100000000);
        DEBUG_DEF(DEBUG_DSP2,     0b00000000000000000000001000000000);
        DEBUG_DEF(DEBUG_FPGA,     0b00000000000000000000010000000000);
        DEBUG_DEF(DEBUG_UART,     0b00000000000000000000100000000000);
        DEBUG_DEF(DEBUG_INI,      0b00000000000000000001000000000000);
        DEBUG_DEF(DEBUG_STATE,    0b00000000000000000010000000000000);
        DEBUG_DEF(DEBUG_TIMER,    0b00000000000000000100000000000000);
        DEBUG_DEF(DEBUG_FX,       0b00000000000000001000000000000000);
        DEBUG_DEF(DEBUG_CARD,     0b00000000000000010000000000000000);
